    ...
    _createClass(ProductItemColorSwatch, [{
      ...
      value: function recalculateSwatches() {
        ...
        fastdom.measure(function () {
          ...
          // the width
          _this2.element.querySelectorAll('.product-item__swatch-list').forEach(function (swatchList) {
    ...
    _createClass(ProductSection, [{
      ...
      value: function _initShopifyReviews() {
        ...
        window.SPRCallbacks.onFormSuccess = function () {
          _this4.element.querySelector('#shopify-product-reviews .spr-form').classList.add('spr-form-submitted');
        };
      ...
      value: function _createCarousel() {
        ...
        if (this.productGalleryElement && parseInt(this.productGalleryElement.getAttribute('data-image-count')) > 1) {
          ...
          filteredCells.forEach(function (item, index) {
            if (item.getAttribute('data-image-id') === _this5.productGalleryElement.getAttribute('data-initial-image-id')) {
              initialIndex = index;
            }
          });
      ...
      value: function _onGallerySlideChanged() {
        ...
        this.productThumbnailsCellsElements.forEach(function (item) {
          ...
          if (item.getAttribute('data-image-id') === _this6.flickityInstance.selectedElement.getAttribute('data-image-id')) {
            newNavElement = item;
          }
        });
      ...
      value: function _onVariantChanged(event) {
        ...
        fastdom.mutate(function () {
          _this7.productGalleryCellsElements.forEach(function (cell, imageIndex) {
            if (cell.hasAttribute('data-group-name')) {
              ...
              _this7.options['productOptions'].forEach(function (option, optionIndex) {
                if (option.toLowerCase() === groupName) {
                  ...
                  if (newVariant['option' + (optionIndex + 1)].toLowerCase() === cell.getAttribute('data-group-value') || newVariant['featured_image'] && newVariant['featured_image']['id'] === parseInt(cell.getAttribute('data-image-id'))) {
                    ...
                    _this7.productThumbnailsCellsElements[imageIndex].classList.remove('is-filtered');
                  } else {
                    cell.classList.add('is-filtered');
                    _this7.productThumbnailsCellsElements[imageIndex].classList.add('is-filtered');
                  }
                }
              });
          ...
          if (shouldReload) {
            _this7.flickityInstance.deactivate();
            _this7.flickityInstance.activate();
          }

          if (newVariant && newVariant['featured_image']) {
            _this7.flickityInstance.selectCell('[data-image-id="' + newVariant['featured_image']['id'] + '"]');
          }
        });
      }
    }]);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__helper_Form__ = __webpack_require__(4);
  ...
  var Cart = function () {
    ...
    _createClass(Cart, [{
      ...
      value: function destroy() {
        ...
        window.removeEventListener('resize', this._windowResizedListener);
      }
    }, {
      key: '_attachListeners',
      value: function _attachListeners() {
        ...
        this.delegateRoot.on('blur', '.quantity-selector__value', this._updateQuantity.bind(this));
      ...
      value: function _openMiniCart() {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__helper_Responsive__["default"].getCurrentBreakpoint() === 'phone') {
          ...
          this.miniCartElement.style.maxHeight = window.innerHeight - document.querySelector('.header').getBoundingClientRect().bottom + 'px';
        }
      ...
      value: function _updateQuantity(event, target) {
        ...
        if (target.hasAttribute('contenteditable')) {
          // To prevent reloading if the content has not changed, let's compare with current value
          var currentValue = parseInt(target.getAttribute('data-current-value'));
          parsedQuantity = parseInt(target.innerText);

          if (!Number.isInteger(parsedQuantity)) {
            parsedQuantity = 1;
          }

          target.innerText = parsedQuantity;
    ...
    _createClass(DesktopNavigation, [{
      ...
      value: function _deactivateDropdown(event, target) {
        ...
        if (this.openTrigger === 'click') {
          ...
          var index = this.openItems.indexOf(target);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_1__helper_Form__ = __webpack_require__(4);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__helper_Animation__ = __webpack_require__(3);
  ...
  var ProductVariants = function () {
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateSelectors(newVariant) {
        ...
        if (!newVariant || this.productData['options'].length <= 1) {
          return;
        }
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_1__Animation__ = __webpack_require__(3);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__helper_Animation__ = __webpack_require__(3);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_16__ValuePicker__ = __webpack_require__(6);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__helper_Accessibility__ = __webpack_require__(8);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_1__helper_Animation__ = __webpack_require__(3);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__components_ShippingEstimator__ = __webpack_require__(10);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_1__helper_Form__ = __webpack_require__(4);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__ProductSection__ = __webpack_require__(7);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_4__components_ValuePicker__ = __webpack_require__(6);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_5__components_CollectionFilterDrawer__ = __webpack_require__(12);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_6__components_ProductItemColorSwatch__ = __webpack_require__(5);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_7__sections_ProductSection__ = __webpack_require__(7);
  ...
  var CollectionSection = function () {
    ...
    _createClass(CollectionSection, [{
      ...
      value: function _reload(pushState) {
        ...
        return fetch(this.currentUrl.toString(), {
          credentials: 'same-origin',
          method: 'GET'
        }).then(function (response) {
          response.text().then(function (content) {
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_0__helper_Form__ = __webpack_require__(4);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_1__helper_Responsive__ = __webpack_require__(0);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__components_ProductItemColorSwatch__ = __webpack_require__(5);
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_3__ProductSection__ = __webpack_require__(7);
      ...
      value: function _fetchProducts() {
        ...
        fetch('/search?view=' + template + '&type=product&q=' + queryString, {
          ...
          response.text().then(function (content) {
            ...
            // Set the content
            _this48.element.innerHTML = tempElement.querySelector('[data-section-type="recently-viewed-products"]').innerHTML;

            _this48.productItemColorSwatch.recalculateSwatches();

            // Convert any amount (if applicable)
            if (window.theme.currencyConversionEnabled) {
              __WEBPACK_IMPORTED_MODULE_0__helper_Currency__["default"].convertAll(_this48.element);
            }
            ...
            _this48.flickityInstance = new Flickity(_this48.element.querySelector('.product-list'), {
              watchCSS: true,
              pageDots: false,
              prevNextButtons: true,
              contain: true,
    ...
    _createClass(SectionContainer, [{
      ...
      value: function register(type, constructor) {
        ...
        document.querySelectorAll('[data-section-type=' + type + ']').forEach(function (container) {
          _this49._createInstance(container, constructor);
        });
      }
    ...
    _createClass(VideoSection, [{
      ...
      value: function _selectVideo(event, target) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__helper_Dom__["default"].getSiblings(target, '.is-selected').forEach(function (previousVideoPreviewElement) {
          var previousVideo = _this50.videos[parseInt(previousVideoPreviewElement.getAttribute('data-video-index'))];
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_16__ProductSection__ = __webpack_require__(7);
